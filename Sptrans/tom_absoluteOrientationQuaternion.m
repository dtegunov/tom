% [s R T error] = tom_absoluteOrientationQuaternion( A, B, doScale)
%
% the original Matlab routine was provided by Dr. Christian Wengert and
% Dr. Gerald Bianchi.
%
...
%           [s R T error] = tom_absoluteOrientationQuaternion( A', A', 0)
%
%

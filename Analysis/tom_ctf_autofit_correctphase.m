function tom_ctf_autofit_correctphase(directory,min_freq,max_freq,enhance_filter_min,enhance_filter_max,enhance_weight,outdir,method,epsilon)
...
parfor (i=1:length(dircell))
    file = [directory '/test2_' num2str(i) '.em'];
    %file = dircell{i};

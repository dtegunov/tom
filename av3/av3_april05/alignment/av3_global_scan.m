...
% av3_global_scan aligns 3D subtomograms to reference - exhaustive scan!
%
...
%   sub-pixel accuracy.
%   General remark: Due to the extensive computing time, only use this
%   function if you do not have ANY guess about the orientations of the
%   particles. Otherwise better use AV3_TRANS-ROT-ALIG.
%
%  PARAMETERS
...
%
%   11/05/04 FF
%last change 03/31/05 - binning changed

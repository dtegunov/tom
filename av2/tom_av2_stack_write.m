function [sucess_vector name_string]=tom_av2_stack_write(stack,outfilestruct,positions,save_outfile_flag)
...
%
%  OUTPUT
%   sucess_vector           positions with writing error
%   names                   cell containing the output names  
%
%
%EXAMPLE
% 
...
if strcmp(outfilestruct.method,'singleFiles')==1
    ...
    for i=1:size(stack,3)
        ...
        name_string{i}=[folder_basename num2str(folder_num)  '/' file_name num2str(positions(i))  file_extension ];
       
        
        sucess=save_write(name_string{i},stack(:,:,i),fileformat);

function [Matrixmark, psi, sigma, x, y, z]  = tom_alignment3d(Matrixmark, irefmark, imintilt, r, imdim, handflip)
...
%   handflip            tom_alignment3d can only determine tilt axis
%                       between 0 and 180 deg. if tilt axis is known to be
%                       between 180 and 360, 180 deg need to be added to
%                       tilt axis (parameter psi).
%  
%  OUTPUT
...
%
%   created by FF 07/25/02
%   updated by FF 08/02/03
%   last change: r set to default if [0,0,0], handflip (FF)
%

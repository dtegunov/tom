function av3_scan_angles_nodisp(refilename, motlfilename, particlefilename, startindx, iterations,angincr, ...
...
%   angiter,mask,hipass,lowpass,nfold,threshold,wedgelist,iclass)

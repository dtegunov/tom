...
if scriptflag == 1
    ...
    [status result]=unix(['ssh berlin "cd /fs/sandy02/lv05/pool/bmsan/rockel/pool-b_baumei/EMANcombi_6/REINER/SEGS/RUN_3/OUTPUT4SEGS && mpirun -ssi rpi tcp -np ' num2str(nr_procs) ' ' molmatch_path ' ' volumefile ' ' templatefile ' ' Outputfile  ' ' angles ' ' psffile ' ' maskfile ' ' num2str(fftsize) ' | tee ' logfile '"'],'-echo');

function tom_av2_align_hightolow_list_beate(base_path1,ext1,base_path2,ext2,filename_list,flag)
...
%                          (high_even,high_even or 2folders )
%  OUTPUT
%
%EXAMPLE
%     
%   tom_av2_align_hightolow_list_beate('/fs/scratch/fbeck/test_htl_al/high_low/test_','.em','','','list.txt','low_odd');
...
%
%   tom_av2_align_hightolow_list_beate('high_low/test_','.em','','','list.txt','low_odd');

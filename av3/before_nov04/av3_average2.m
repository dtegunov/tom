function [average, av_ps] = av3_average2(motivelist, filename, r, flag, class)
%AV3_AVERAGE2  performs averaging of 3D-particles
%
%USAGE
...
%   FILENAME      string; filenames - expected as "FILENAME_number.em" of

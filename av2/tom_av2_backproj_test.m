function [vol error_m]=tom_av2_backproj(align2d,iter_num,disp_flag,interv)
%TOM_AV2_BACKPROJ creates ...
%
%   [vol error_m]=tom_av2_backproj(align2d,iter_num,disp_flag,interv)
%
%PARAMETERS
%
%  INPUT
...
for i=interv(1):interv(2)
        ...
        if (num_of_p~=0) 
            ...
            %read class avg
            part=tom_emreadc([align2d(iter_num,1).filename],'subregion',[1 1 i],[size_stack(1)-1 size_stack(2)-1 0]);

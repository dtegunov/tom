%TOM_AV3_CORR32 does normalised cross correlation of a list of templates 
% with a list of particles, for a given set of rotations.
%
%   [out] = tom_av3_corr3d([type], size, templates, particles, angles,
...
function varargout = tom_av3_corr3d(varargin)

varargout{:} = tom_mex_corr3d(varargin{:});

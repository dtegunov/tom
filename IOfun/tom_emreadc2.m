function Data = tom_emreadc2(varargin)
%TOM_EMREADC reads data in EM-file format. 
%
%Data = tom_emreadc2(varargin)
%
...
%   updated by AK 12/22/05 added completely new c backend with support for subregion
...
%   updated by AK 31/08/06 fixed endian swap when binning is used, added binning

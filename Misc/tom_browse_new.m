...
if eventdata.Key=='c'
    if isequal(handles.filetype,'directory')
        ...
        [success,message,messageid]=copyfile(handles.filename,directoryname);
        if success==1
        ...
        [success,message,messageid]=copyfile(handles.filename,[pathname filename]);
        if success==1
            disp(['Source        : ', fullfile(handles.filename)])

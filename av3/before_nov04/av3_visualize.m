function av3_visualize(motl, particlefilename, iclass, mode, delta)

%AV3_VISUALIZE  visualizes 3D-particles
%
%USAGE
%   av3_visualize(motivelist, filename, iclass, mode);
%
%   MOTL                Motive list
...
for indpart = 1:size(motl,2)
    if ((motl(20,indpart) == 1) | (motl(20,indpart) == 2) | (motl(20,indpart) == iclass))
        ...
        particle  = double(tom_rotate(tom_shift(particle.Value,-tshift),[-psi_opt,-phi_opt,-the_opt]));

...
%   phi_end      phi angle chosen as last one to be scanned
%   psi_end      psi angle chosen as last one to be scanned
%   theta_end    theta angle chosen as last one to be scanned
%   angular_incr angular increment used for scan
%   phi_start    phi angle chosen as start value
%   psi_start    psi angle chosen as start value
%   theta_start  theta angle chosen as start value
%
%  OUTPUT
%   phi          phi angle corresponding to INDEX
%   psi          psi angle corresponding to INDEX
%   theta        theta angle corresponding to INDEX
%   
%  SEE ALSO
